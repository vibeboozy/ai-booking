    ...
    return (
      <main className="mx-auto max-w-2xl px-4 py-8">
        <div className="rounded-lg border border-red-200 bg-red-50 p-6 text-center dark:border-red-800 dark:bg-red-900/20">
          <h1 className="text-xl font-semibold text-red-800 dark:text-red-400">
    ...
    return (
      <main className="mx-auto max-w-2xl px-4 py-8">
        <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-6 text-center dark:border-yellow-800 dark:bg-yellow-900/20">
          <h1 className="text-xl font-semibold text-yellow-800 dark:text-yellow-400">
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-8">
      ...
      <nav className="mb-6 flex items-center gap-2 text-sm text-gray-500">
        ...
        <span>/</span>
        <Link href="/profile/trips" className="hover:text-gray-700 dark:hover:text-gray-300">
          Мои поездки
        </Link>
        <span>/</span>
        <span className="text-gray-900 dark:text-gray-200">Отзыв</span>
      </nav>

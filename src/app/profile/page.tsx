    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <main className="mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Link
            href="/profile/trips"
            className="flex items-center gap-4 rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md dark:border-gray-700 dark:bg-gray-800"
          >
            <span className="text-3xl">✈️</span>
            <div>
              <h2 className="font-semibold">Мои поездки</h2>
              <p className="text-sm text-gray-500">Предстоящие и прошедшие бронирования</p>
            </div>
          </Link>
